...
public class CustomLoadingLayout extends LoadingLayout {
	...
	public CustomLoadingLayout(Context context, final Mode mode, final Orientation scrollDirection, TypedArray attrs) {
		...
		playoutParams.width = DensityUtils.dip2px(getContext(), 30);
		playoutParams.height = DensityUtils.dip2px(getContext(), 30);
		mHeaderProgress.setLayoutParams(playoutParams);
		mHeaderProgress.setIndeterminateDrawable(getResources().getDrawable(R.drawable.extend_pulltorefresh_drawable_progress));
	}
	...
	protected int getDefaultDrawableResId() {
		return R.drawable.pulltorefresh_pinnedheader_pull_other_flip;
	}
