 ...
 * <p>
 * note: wechat, yixin, qzone, etc. are shared in their clients, not in this page
 */
public class EditPage extends EditPageFakeActivity implements OnClickListener, TextWatcher {
	...
	private LinearLayout getAtLine(String platform) {
		if (!isShowAtUserLayout(platform)) { return null; }
	...
	private Bitmap getPlatLogo(Platform plat) {
		...
		if (resId > 0) { return BitmapFactory.decodeResource(activity.getResources(), resId); }
		return null;
	}
