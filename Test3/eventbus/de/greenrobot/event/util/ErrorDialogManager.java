 ...
 * <li>Use one of {@link #attachTo(Activity)}, {@link #attachTo(Activity, boolean)} or {@link #attachTo(Activity, boolean, Bundle)} in your Activity, typically in onCreate.</li>
 * </ol>
...
public class ErrorDialogManager {
	...
	public static class SupportManagerFragment extends Fragment {
		...
		public void onEventMainThread(ThrowableFailureEvent event) {
			if (!isInExecutionScope(executionScope, event)) { return; }
	...
	private static boolean isSupportActivity(Activity activity) {
		...
		for (Class<?> c = activity.getClass().getSuperclass();; c = c.getSuperclass()) {
			if (c == null) { throw new RuntimeException("Illegal activity type: " + activity.getClass()); }
			...
			if (name.equals("android.support.v4.app.FragmentActivity")) {
				...
				if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) { throw new RuntimeException("Illegal activity without fragment support. Either use Android 3.0+ or android.support.v4.app.FragmentActivity."); }
				break;
			}
		}
		return isSupport;
