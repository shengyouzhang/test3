...
//		Drawable bg = styleAttrs.hasValue(R.styleable.PullToRefreshHeader_ptrHeaderBackground_uk) ? styleAttrs.getDrawable(R.styleable.PullToRefreshHeader_ptrHeaderBackground_uk) : getActionBarBackground(activity);
